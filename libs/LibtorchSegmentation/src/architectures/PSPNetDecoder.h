...
class LIBTORCHSEGMENTATION_EXPORT PSPBlockImpl : public torch::nn::Module {
public:
...
class LIBTORCHSEGMENTATION_EXPORT PSPModuleImpl : public torch::nn::Module {
public:
...
class LIBTORCHSEGMENTATION_EXPORT PSPDecoderImpl : public torch::nn::Module {
public:
