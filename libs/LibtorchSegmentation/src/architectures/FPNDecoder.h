...
#include "LibtorchSegmentation_export.h"

class LIBTORCHSEGMENTATION_EXPORT Conv3x3GNReLUImpl : public torch::nn::Module
{
public:
...
class LIBTORCHSEGMENTATION_EXPORT FPNBlockImpl : public torch::nn::Module
{
public:
...
class LIBTORCHSEGMENTATION_EXPORT SegmentationBlockImpl: public torch::nn::Module
{
public:
...
class LIBTORCHSEGMENTATION_EXPORT MergeBlockImpl: public torch::nn::Module{
public:
...
class LIBTORCHSEGMENTATION_EXPORT FPNDecoderImpl: public torch::nn::Module
{
public:
