...
class LIBTORCHSEGMENTATION_EXPORT DecoderBlockLinkImpl : public torch::nn::Module {
public:
...
class LIBTORCHSEGMENTATION_EXPORT LinknetDecoderImpl : public torch::nn::Module
{
public:
