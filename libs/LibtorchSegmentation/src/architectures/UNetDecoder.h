...
//attention and basic
class LIBTORCHSEGMENTATION_EXPORT SCSEModuleImpl: public torch::nn::Module{
public:
...
class LIBTORCHSEGMENTATION_EXPORT Conv2dReLUImpl: public torch::nn::Module{
public:
...
class LIBTORCHSEGMENTATION_EXPORT DecoderBlockImpl: public torch::nn::Module{
public:
...
class LIBTORCHSEGMENTATION_EXPORT UNetDecoderImpl:public torch::nn::Module
{
public:
