...
int main(int argc, char** argv)
{
    ...
    cv::Mat image = cv::imread("C:/Users/Sietze/source/repos/CellSegmentation/libs/LibtorchSegmentation/voc_person_seg/val/2007_004000.jpg");

    Segmentor<FPN> segmentor;
    segmentor.Initialize(-1,512,512,{"background","person"},
                         "resnet34","C:/Users/Sietze/source/repos/CellSegmentation/pretrained/resnet34.pt");
    segmentor.LoadWeight("C:/Users/Sietze/source/repos/CellSegmentation/pretrained/segmentor.pt");
